...
ADVERSARIAL_COVERAGE = [
    ...
    ("Q1", "missing Required dependency", "mechanical", "missing link target -> WL-UNRESOLVED / LC-UNRESOLVED (fixtures 04, 05)"),
    ("Q2", "superseded Required dependency", "requires AI", "lifecycle enumerates superseded; blocking a Job is AI"),
    ("Q3", "malformed Required note", "mechanical", "FM-UNPARSEABLE foundation"),
    ("Q4/Q5", "optional deps, Job isolation", "requires AI", "scope judgment; validator isolates by being per-file deterministic"),
    ("Q6", "Required current positive control", "requires AI", "lifecycle accepts memory_status: current; Job proceeds is AI"),
    ("Q7/Q8/Q9", "claim class blocks candidate/deprecated/absent", "requires AI", "lifecycle enumerates each state; currentness-vs-degraded resolution is AI"),
    ("Q10", "stale under declared recency window", "requires AI", "last_confirmed is machine-read (schema); window comparison is AI"),
    ("Q11", "malformed declaration", "requires AI", "declaration grammar is prose; the deterministic failure is AI"),
    ("Q12", "Preferred never blocks", "requires AI", "degraded Preferred proceeds+discloses; tier judgment is AI"),
    ("Q13", "superseded blocks both classes", "requires AI", "lifecycle enumerates superseded (mechanical input); gating is AI"),
    ...
    ("I6/I7", "Jobs under incompatible", "requires AI", "LC-DISPUTED gives the reason; Job gating is AI"),
