...
## Scope
Level 1 (structural) over the full vault; structural files excluded from index expectations.
...
## Level evidence
- [x] partition complete (5 inspected + 4 excluded); every exclusion is structural
